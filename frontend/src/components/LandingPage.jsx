            ...
            <section className="landing-hero">
                ...
                <div className="landing-hero-inner">
                    ...
                    <p className="landing-hero-subtitle">
                        Elevatr is a better way to showcase projects, find jobs, and connect talent with opportunity for students and recruiters.
                    </p>
            ...
            <section className="landing-section landing-section-alt landing-animate">
                <div className="landing-features-header">
                    ...
                    <p className="landing-section-desc" style={{ maxWidth: 560, margin: '0 auto' }}>
                        Elevatr is a better way to find jobs, showcase projects, and connect talent — built for students and recruiters.
                    </p>
                </div>
