            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  At Elevatr, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-100 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <a href="mailto:privacy@elevatr.com" className="text-green-600 hover:text-green-700 font-semibold">
                    privacy@elevatr.com
                  </a>
                </p>
              </div>
