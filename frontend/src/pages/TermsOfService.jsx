        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-orange-100 max-w-4xl mx-auto mb-4 leading-relaxed">
              Please read these terms carefully before using Elevatr
            </p>
            ...
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  By accessing or using Elevatr, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this platform.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-100 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Permission is granted to temporarily access Elevatr for personal, non-commercial use only. This is the grant of a license, not a transfer of title, and under this license you may not:
                </p>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Elevatr shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-100 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <a href="mailto:legal@elevatr.com" className="text-orange-600 hover:text-orange-700 font-semibold">
                    legal@elevatr.com
                  </a>
                </p>
              </div>
